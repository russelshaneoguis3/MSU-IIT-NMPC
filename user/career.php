...
include("../connection.php");
  ...
  $selectQuery = "SELECT job_id, branch_loc, date_pos, position, job_img, branch_id, branch_name, location FROM job, branch where branch_loc = branch_id";
...
<br>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="margin-left:120px;">Careers</h1>
      <nav>
        <ol class="breadcrumb">
...
<!-- Display existing job records in separate cards -->
        ...
        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
            <div class="col-md-3 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><i class="ri-newspaper-line"></i><?php echo " ", $row['position']; ?></span></h5>
                        <span><i class="ri-map-pin-5-line"></i><?php echo " ", $row['branch_name']; ?></span><br>
                        <span><i class="ri-map-pin-line"></i><?php echo " ", $row['location']; ?> </span><br>
                        <span><i class="ri-map-pin-time-line"></i><?php echo " ", $row['date_pos']; ?></span><br><br>
                        <span><a href="career-info.php?job_id=<?php echo $row['job_id']; ?>" class="btn btn-primary"><i class="fa-solid fa-eye"></i> View Job</a></span>
                    </div>
                </div>
            </div>
        <?php } ?>

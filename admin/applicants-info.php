  ...
  if (isset($_SESSION['id']) && isset($_SESSION['username']) && $_SESSION['role'] === 'administrator') {
          ...
          $query = "SELECT ja.applicant_id, ja.address, ja.job_applied, ja.app_name, ja.contact_no, ja.email, j.position, ja.degree, ja.app_letter, ja.app_resume, ja.other,
          CONCAT(b.branch_name, '<br>', ' ', b.location) as loc,
                ja.app_date
                FROM job_applicants ja
                INNER JOIN job j ON ja.job_applied = j.job_id
                INNER JOIN branch b ON j.branch_loc = b.branch_id where ja.applicant_id = $applicant_id";
  ...
  ?>
      <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="applicants.php">Back</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-7">
            ...
            <h5><b><?php echo $row['position']; ?></b></h5>
            <p><b>Branch:</b> <?php echo $row['loc']; ?></p>
            <p><b>Application Date:</b> <?php echo $row['app_date']; ?></p>
            <p><b>Applicant Name:</b> <?php echo $row['app_name']; ?></p>
            <p><b>Education/Degree:</b> <?php echo $row['degree']; ?></p>
...
<div class="col-md-6 mb-7">
            ...
            <div class="card">
                <div class="card-body">
            <h2 class="card-title">Applicant's Documents</h2>
            
            <p><b> Application Letter: &nbsp </b><a href="<?php echo $row['app_letter']; ?>" target="_blank">View Application Letter</a></p>
            <p><b> Resume: &nbsp </b><a href="<?php echo $row['app_resume']; ?>" target="_blank">View Resume</a></p>
            
            <?php if (($row['other'] === '../files/')): ?>
            <p><b>Other Document: &nbsp;</b>None</p>
            <?php else: ?>
            <p><b>Other Document: &nbsp;</b><a href="<?php echo $row['other']; ?>" target="_blank">View Other Document</a></p>
            <?php endif; ?>
